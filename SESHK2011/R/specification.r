...
genSpecStandardMath <- function(network=c("all","friends","studymates"), network_formation_fixed_effect = FALSE){
  ...
  network_formation_formula <- (
    ...
    + I( (violin == friends_violin) 
          + (piano == friends_piano) 
          + (guitar == friends_guitar) 
          + (harp == friends_harp) 
          + (horn == friends_horn) 
          + (flute == friends_flute) 
          + (clarinet == friends_clarinet) 
          + (cello == friends_cello) 
          + (melodica == friends_melodica) 
          + (bell == friends_bell) 
          + (erhu == friends_erhu) 
          + (guzheng == friends_guzheng) 
          + (pipa == friends_pipa) 
          + (yangqin == friends_yangqin) 
          + (chinese_flute == friends_chinese_flute) 
          + (yuan == friends_yuan) 
          + (chinese_lo == friends_chinese_lo) 
          + (recorder == friends_recorder) 
          + (xylophone == friends_xylophone) 
          + (keyboard == friends_keyboard) 
          + (electric_guitar == friends_electric_guitar) 
          + (harmonica == friends_harmonica) 
          + (africa_drum == friends_africa_drum) 
          + (percussion == friends_percussion) 
          + (saxophone == friends_saxophone) 
          + (drum == friends_drum) 
          + (ocarina == friends_ocarina) 
      )
    + I( (boyscout == friends_boyscout) 
          + (girlguide == friends_girlguide) 
          + (boybrigade == friends_boybrigade) 
          + (girlbrigade == friends_girlbrigade) 
          + (stjohn == friends_stjohn) 
          + (jpc == friends_jpc) 
          + (sst == friends_sst) 
          + (cyc == friends_cyc) 
          + (rsp == friends_rsp) 
          + (red_cross == friends_red_cross) 
          + (flag == friends_flag) 
          + (prefect == friends_prefect) 
          + (Teen == friends_Teen) 
          + (leadership == friends_leadership) 
          + (civilaid == friends_civilaid) 
          + (cheerlead == friends_cheerlead) 
          + (volunteer == friends_volunteer) 
          + (marchingband == friends_marchingband) 
          + (britishcouncil == friends_britishcouncil) 
      )
    + I( (basketball == friends_basketball) 
          + (soccer == friends_soccer) 
          + (pingpong == friends_pingpong) 
          + (badminton == friends_badminton) 
          + (volleyball == friends_volleyball) 
          + (golf == friends_golf) 
          + (bowling == friends_bowling) 
          + (tennis == friends_tennis) 
          + (squash == friends_squash) 
          + (rugby == friends_rugby) 
          + (dodgeball == friends_dodgeball) 
          + (handball == friends_handball) 
          + (ropeskip == friends_ropeskip) 
          + (mountaineer == friends_mountaineer) 
          + (athletics == friends_athletics) 
          + (swim == friends_swim) 
          + (skiing == friends_skiing) 
          + (rowing == friends_rowing) 
          + (hurdle == friends_hurdle) 
          + (archery == friends_archery) 
          + (cycling == friends_cycling) 
          + (chinese_dance == friends_chinese_dance) 
          + (latin_dance == friends_latin_dance) 
          + (dance == friends_dance) 
          + (ballet == friends_ballet) 
          + (karate == friends_karate) 
          + (Taekwondo == friends_Taekwondo) 
          + (Yudo == friends_Yudo) 
          + (kungfu == friends_kungfu) 
          + (taiqi == friends_taiqi) 
          + (lion == friends_lion) 
          + (run == friends_run) 
          + (gun == friends_gun) 
          + (slideboard == friends_slideboard) 
          + (yoyo == friends_yoyo) 
          + (shotput == friends_shotput) 
          + (gymnastics == friends_gymnastics) 
          + (fencing == friends_fencing) 
          + (climbing == friends_climbing) 
